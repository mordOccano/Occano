...
import com.e.occano.fragments.main.alerts.AlertsNavHostFragment
import com.e.occano.fragments.main.dashboard.DashboardNavHostFragment
import com.e.occano.fragments.main.graphs.GraphNavHostFragment
    ...
    private fun createNavHost(menuItemId: Int): Fragment{
        return when(menuItemId){
            ...
            R.id.menu_nav_account -> {
                AlertsNavHostFragment.create(R.navigation.alerts_nav_graph)
            }

            R.id.menu_nav_blog -> {
                DashboardNavHostFragment.create(R.navigation.dashboard_nav_graph)
            }

            R.id.menu_nav_create_blog -> {
                GraphNavHostFragment.create(R.navigation.graphs_nav_graph)
            }
